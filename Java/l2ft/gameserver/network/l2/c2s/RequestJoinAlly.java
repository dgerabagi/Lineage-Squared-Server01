...
import l2ft.gameserver.network.l2.s2c.AskJoinAlliance;
...
public class RequestJoinAlly extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			activeChar.sendMessage(new CustomMessage("l2ft.gameserver.clientpackets.RequestJoinAlly.InvitePenalty", activeChar));
			return;
		}
