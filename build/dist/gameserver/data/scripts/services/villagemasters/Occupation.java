...
public class Occupation extends Functions
{
	public void onTalk30026()
	{
		...
		String htmltext;
		ClassId classId = pl.getActiveClassClassId();
	...
	public void onChange30037(String[] args)
	{
		...
		if(classid == 26 && pl.getActiveClassClassId() == ClassId.elvenMage)
		{
		...
		else if(classid == 29 && pl.getActiveClassClassId() == ClassId.elvenMage)
		{
		...
		else if(classid == 11 && pl.getActiveClassClassId() == ClassId.mage)
		{
		...
		else if(classid == 15 && pl.getActiveClassClassId() == ClassId.mage)
		{
	...
	public void onChange32199(String[] args)
	{
		...
		if(classid == 130 && pl.getActiveClassClassId() == ClassId.warder)
		{
		...
		else if(classid == 129 && pl.getActiveClassClassId() == ClassId.warder)
		{
		...
		else if(classid == 127 && pl.getActiveClassClassId() == ClassId.trooper)
		{
		...
		else if(classid == 128 && pl.getActiveClassClassId() == ClassId.trooper)
		{
			if(Level <= 39 && pl.getInventory().getItemByItemId(SB_Certificate) == null)
				htmltext = "16.htm";
			else if(Level <= 39 && pl.getInventory().getItemByItemId(SB_Certificate) != null)
