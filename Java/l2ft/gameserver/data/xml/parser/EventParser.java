...
import l2ft.gameserver.model.entity.events.actions.ActiveDeactiveAction;
import l2ft.gameserver.model.entity.events.actions.AnnounceAction;
import l2ft.gameserver.model.entity.events.actions.GiveItemAction;
import l2ft.gameserver.model.entity.events.actions.IfElseAction;
import l2ft.gameserver.model.entity.events.actions.InitAction;
import l2ft.gameserver.model.entity.events.actions.NpcSayAction;
import l2ft.gameserver.model.entity.events.actions.OpenCloseAction;
import l2ft.gameserver.model.entity.events.actions.PlaySoundAction;
import l2ft.gameserver.model.entity.events.actions.RefreshAction;
import l2ft.gameserver.model.entity.events.actions.SayAction;
import l2ft.gameserver.model.entity.events.actions.SpawnDespawnAction;
import l2ft.gameserver.model.entity.events.actions.StartStopAction;
import l2ft.gameserver.model.entity.events.actions.TeleportPlayersAction;
...
public final class EventParser extends AbstractDirParser<EventHolder>
{
	...
	protected void readData(Element rootElement) throws Exception
	{
		for(Iterator<Element> iterator = rootElement.elementIterator("event"); iterator.hasNext();)
		{
			...
			try
			{
				eventClass = (Class<GlobalEvent>) Class.forName("l2ft.gameserver.model.entity.events.impl." + impl + "Event");
			}
