...
public class _215_TrialOfPilgrim extends Quest implements ScriptFile
{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		{
			if(st.getPlayer().getActiveClassClassId().getId() == 0x0f || st.getPlayer().getActiveClassClassId().getId() == 0x1d || st.getPlayer().getActiveClassClassId().getId() == 0x2a || st.getPlayer().getActiveClassClassId().getId() == 0x32)
			{
