package l2ft.gameserver.ccpGuard;

import l2ft.gameserver.ccpGuard.managers.HwidBan;
import l2ft.gameserver.ccpGuard.managers.HwidManager;
import l2ft.gameserver.ccpGuard.managers.ProtectManager;
import static l2ft.gameserver.ccpGuard.commons.utils.Util.verifyChecksum;
import static l2ft.gameserver.ccpGuard.commons.utils.Util.LastErrorConvertion;
import l2ft.gameserver.ccpGuard.commons.utils.Log;
import l2ft.gameserver.ccpGuard.packets.ServerTitleSpecial;
...
public final class Protection
{
	...
	public static boolean doAuthLogin(GameClient client, byte[] data, String loginName)
	{
		...
		{
			client.close(ServerTitleSpecial.STATIC);
		}*/
		return true;
	}
