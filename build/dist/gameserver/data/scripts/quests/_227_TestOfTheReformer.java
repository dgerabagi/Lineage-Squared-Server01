...
/**
 * ĐšĐ˛ĐµŃ�Ń‚ Đ˝Đ° Đ˛Ń‚ĐľŃ€Ń�ŃŽ ĐżŃ€ĐľŃ„ĐµŃ�Ń�Đ¸ŃŽ Test Of The Reformer
 *
...
public class _227_TestOfTheReformer extends Quest implements ScriptFile
{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == Pupina)
		{
			...
			{
				if(st.getPlayer().getActiveClassClassId().getId() == 0x0f || st.getPlayer().getActiveClassClassId().getId() == 0x2a)
				{
