...
/**
 * ĐšĐ˛ĐµŃ�Ń‚ Đ˝Đ° Đ˛Ń‚ĐľŃ€Ń�ŃŽ ĐżŃ€ĐľŃ„ĐµŃ�Ń�Đ¸ŃŽ Test Of Magus
 *
...
public class _228_TestOfMagus extends Quest implements ScriptFile
{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == Rukal)
		{
			...
			{
				if(st.getPlayer().getActiveClassClassId().getId() == 0x0b || st.getPlayer().getActiveClassClassId().getId() == 0x1a || st.getPlayer().getActiveClassClassId().getId() == 0x27)
				{
