...
echo -ne "\nPlease enter MySQL Login Server database name (default l2ft): "
read LSDB
if [ -z "$LSDB" ]; then
  LSDB="l2ft"
fi
...
echo "visit http://www.first-team.ru for more info about"
echo "the First Team project."
exit 0
}
