...
public class _230_TestOfSummoner extends Quest implements ScriptFile
{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		{ // start part, Galatea
			for(String var : STATS)
				st.set(var, "0");
			if(st.getPlayer().getActiveClassClassId() == ClassId.wizard || st.getPlayer().getActiveClassClassId() == ClassId.elvenWizard || st.getPlayer().getActiveClassClassId() == ClassId.darkWizard)
