...
import l2ft.gameserver.network.l2.s2c.AskJoinParty;
...
public class RequestJoinParty extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if(activeChar.isInParty())
		{
			...
			{
				activeChar.sendMessage(new CustomMessage("l2ft.gameserver.clientpackets.RequestJoinParty.InDimensionalRift", activeChar));
				activeChar.sendActionFailed();
				return;
			}
		}
