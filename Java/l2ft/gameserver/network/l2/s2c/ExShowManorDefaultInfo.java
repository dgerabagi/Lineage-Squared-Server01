// java/l2ft/gameserver/network/l2/s2c/ExShowManorDefaultInfo.java
...
public class ExShowManorDefaultInfo extends L2GameServerPacket {
	...
	protected void writeImpl() {
		...
		for (int cropId : _crops) {
			...
			writeD((int) Manor.getInstance().getCropBasicPrice(cropId)); // crop price
...
// EOF java/l2ft/gameserver/network/l2/s2c/ExShowManorDefaultInfo.java
