...
/**
 * ĐšĐ˛ĐµŃ�Ń‚ Đ˝Đ° Đ˛Ń‚ĐľŃ€Ń�ŃŽ ĐżŃ€ĐľŃ„ĐµŃ�Ń�Đ¸ŃŽ Testimony Of Glory
 *
...
public class _220_TestimonyOfGlory extends Quest implements ScriptFile
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		{
			//ĐźŃ€ĐľĐ˛ĐµŃ€ŃŹĐµĐĽ ĐµŃ�Ń‚ŃŚ Đ»Đ¸ Đ˛ ĐĽĐ¸Ń€Đµ Ń�Đ¶Đµ ĐşĐ˛ĐµŃ�Ń‚ ĐĽĐľĐ˝Ń�Ń‚Ń€Ń‹
			int spawn = 0;
			...
			if(isQuest != null)
				spawn = 1;
			if(spawn == 1) //ĐµŃ�Đ»Đ¸ Ń…ĐľŃ‚ŃŚ ĐľĐ´Đ¸Đ˝ ĐĽĐľĐ± ĐµŃ�Ń‚ŃŚ Đ˛ ĐĽĐ¸Ń€Đµ, Ń�Ń‚Đ°Đ˛Đ¸ĐĽ Ń‚Đ°ĐąĐĽĐµŃ€ Đ˝Đ° Ń�Đ´Đ°Đ»ĐµĐ˝Đ¸Đµ Đ¸Ń…(Đ˝ŃŹ Đ˛Ń�ŃŹĐşĐ¸Đą) + ĐłĐľĐ˛ĐľŃ€Đ¸ĐĽ Đ¸ĐłŃ€ĐľĐşŃ� ĐżĐľĐ´ĐľĐ¶Đ´Đ°Ń‚ŃŚ.
			{
		...
		//Đ”Đ°Đ»ĐµĐµ Đ¸Đ´ĐµŃ‚ 3 Đ˛ĐµĐ»ĐľŃ�Đ¸ĐżĐµĐ´Đ°
		...
		{
			//Đ’ĐµĐ»ĐľŃ�Đ¸ĐżĐµĐ´, Đ˝Đľ Đ˝Ń�Đ¶Đ˝Đľ Ń�Đ´Đ°Đ»Đ¸Ń‚ŃŚ Đ˛Ń�ĐµŃ… 4 ĐľĐ´Đ¸Đ˝Đ°ĐşĐľĐ˛Ń‹Ń… ĐĽĐľĐ±ĐľĐ˛
			NpcInstance isQuest = GameObjectsStorage.getByNpcId(EnkuOrcOverlordQuestMonster);
			if(isQuest != null)
				isQuest.deleteMe();
		...
		{
			//Đ’ĐµĐ»ĐľŃ�Đ¸ĐżĐµĐ´, Đ˝Đľ Đ˝Ń�Đ¶Đ˝Đľ Ń�Đ´Đ°Đ»Đ¸Ń‚ŃŚ Đ˛Ń�ĐµŃ… 2 ĐľĐ´Đ¸Đ˝Đ°ĐşĐľĐ˛Ń‹Ń… ĐĽĐľĐ±ĐľĐ˛
			NpcInstance isQuest = GameObjectsStorage.getByNpcId(MakumBugbearThugQuestMonster);
			if(isQuest != null)
				isQuest.deleteMe();
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == Vokian)
		{
			...
			{
				if(st.getPlayer().getActiveClassClassId().getId() == 45 || st.getPlayer().getActiveClassClassId().getId() == 47 || st.getPlayer().getActiveClassClassId().getId() == 50)
				{
