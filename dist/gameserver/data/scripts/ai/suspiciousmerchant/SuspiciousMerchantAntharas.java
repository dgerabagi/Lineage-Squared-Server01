			...
			if(!wait)
				switch(current_point)
				{
					...
					case 5:
						...
						{
							case 0:
								Functions.npcSay(actor, "How is the weather?");
								break;
							case 1:
								Functions.npcSay(actor, "How is the life?");
								break;
							case 2:
								Functions.npcSay(actor, "Today the weather is nice.");
								break;
							case 3:
								Functions.npcSay(actor, "Have you got strong doors?");
								break;
						}
						wait = true;
						return true;
