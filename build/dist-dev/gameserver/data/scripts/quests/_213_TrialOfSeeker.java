...
/**
 * ĐšĐ˛ĐµŃ�Ń‚ Đ˝Đ° Đ˛Ń‚ĐľŃ€Ń�ŃŽ ĐżŃ€ĐľŃ„ĐµŃ�Ń�Đ¸ŃŽ Trial Of Seeker
 *
...
public class _213_TrialOfSeeker extends Quest implements ScriptFile
{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == Dufner)
		{
			...
			{
				if(st.getPlayer().getActiveClassClassId().ordinal() == 0x07 || st.getPlayer().getActiveClassClassId().ordinal() == 0x16 || st.getPlayer().getActiveClassClassId().ordinal() == 0x23)
		...
		else if(npcId == Terry)
		{
			...
			else if((cond == 14 || cond == 15) && st.getQuestItemsCount(Terrys3rdOrder) > 0)
			{
			...
			else if(cond == 15 || cond == 16) //15 ĐşĐľĐ˝Đ´Đ° ĐżĐľĐşĐ° Đ˝ĐµŃ‚Ń�, Đ¸ Ń…Đ· ĐşĐ°Đş ĐľĐ˝ ĐżĐľĐ»Ń�Ń‡Đ°ĐµŃ‚Ń�ŃŹ
				...
				if(st.getQuestItemsCount(AbyssRunestone1) != 0 && st.getQuestItemsCount(AbyssRunestone2) != 0 && st.getQuestItemsCount(AbyssRunestone3) != 0 && st.getQuestItemsCount(AbyssRunestone4) != 0)
				{
					...
					st.setCond(0); //Đ˘Ń�Ń‚ Đ˝ĐµĐżĐľĐ˝ŃŹŃ‚ĐşĐ¸, Đ˛ ĐşĐ»Đ¸ĐµĐ˝Ń‚Đµ Đ˝ĐµŃ‚Ń� ĐşĐľĐłĐ´Đ° 18, Đ° ĐżĐľŃ�Đ»ĐµĐ´Đ˝Đ¸Đą 17 ĐłĐľĐ˛ĐľŃ€Đ¸Ń‚ Ń‡Ń‚Đľ Đ˝Đ°Đ´Đ° Đ¸Đ´Ń‚Đ¸ Đş Đ˘ĐµŃ€Ń€Đ¸, Đ˝Đľ ĐżĐľŃ�Đ»Đµ Đ˝ĐµĐłĐľ ĐµŃ�Ń‚ŃŚ ĐµŃ‰Đµ ĐľĐ´Đ¸Đ˝ ĐżŃ�Đ˝ĐşŃ‚.  ĐťŃ�Đ¶Đ˝Đ° ĐżŃ€ĐľĐ˛ĐµŃ€ĐşĐ° Ń� ĐľŃ„Ń„ Ń�ĐµŃ€Đ˛ĐµŃ€Đ°.
				}
				else
				{
					htmltext = "terry_q0213_22.htm";
