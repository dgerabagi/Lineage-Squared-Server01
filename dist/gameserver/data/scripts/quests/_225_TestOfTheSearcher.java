...
/**
 * ĐšĐ˛ĐµŃ�Ń‚ Đ˝Đ° Đ˛Ń‚ĐľŃ€Ń�ŃŽ ĐżŃ€ĐľŃ„ĐµŃ�Ń�Đ¸ŃŽ Test Of The Searcher
 *
...
public class _225_TestOfTheSearcher extends Quest implements ScriptFile
{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == Luther)
		{
			...
			{
				if(st.getPlayer().getActiveClassClassId().getId() == 0x07 || st.getPlayer().getActiveClassClassId().getId() == 0x16 || st.getPlayer().getActiveClassClassId().getId() == 0x23 || st.getPlayer().getActiveClassClassId().getId() == 0x36)
				{
