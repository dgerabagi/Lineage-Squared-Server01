...
public class _174_SupplyCheck extends Quest implements ScriptFile
{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == Marcela)
		{
			...
			{
				if(st.getPlayer().getActiveClassClassId().isMage() && !st.getPlayer().getActiveClassClassId().equalsOrChildOf(ClassId.orcMage))
				{
				...
				if(st.getPlayer().getActiveClassClassId().getLevel() == 1 && !st.getPlayer().getVarB("ng1"))
