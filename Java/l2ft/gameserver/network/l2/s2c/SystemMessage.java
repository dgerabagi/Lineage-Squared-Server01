...
public class SystemMessage extends L2GameServerPacket
{
	...
	public static final int SUB_KEY_CAN_BE_CTRL_ALT_SHIFT_AND_YOU_MAY_ENTER_TWO_SUB_KEYS_AT_A_TIME___N_EXAMPLE__CTRL___ALT__ = 2112; // Вспомогательными клавишами могут быть CTRL, ALT, SHIl2ft. Вы можете нажимать две одновременно. Например, "CTRL + ALT + A"
