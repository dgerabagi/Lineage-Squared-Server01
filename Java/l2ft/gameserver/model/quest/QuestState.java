...
public final class QuestState
{
	...
	public double getRateQuestsDrop()
	{
		...
		if(Config.ALLOW_ADDONS_CONFIG)
			return Config.RATE_QUESTS_DROP * AddonsConfig.getQuestDropRates(_quest) * Bonus;
	...
	public double getRateQuestsReward()
	{
		...
		if(Config.ALLOW_ADDONS_CONFIG)
			return Config.RATE_QUESTS_REWARD * AddonsConfig.getQuestRewardRates(_quest) * Bonus;
