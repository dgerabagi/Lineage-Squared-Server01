...
import l2ft.gameserver.network.l2.s2c.ExMultiPartyCommandChannelInfo;
	...
	public boolean useUserCommand(int id, Player activeChar)
	{
		...
		switch(id)
		{
			...
			case 93: //channeldelete
				...
				{
					l2ft.gameserver.model.CommandChannel channel = activeChar.getParty().getCommandChannel();
