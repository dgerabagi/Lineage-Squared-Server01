...
public class _255_Tutorial extends Quest implements ScriptFile, OnPlayerEnterListener
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		else if(event.startsWith("CE"))
		{
			...
			else if(event_id == 40)
			{
				if(player.getLevel() == 5)
					if(st.getInt("lvl") < 5 && !player.getActiveClassClassId().isMage() || classId == 49)
					{
				...
				{
					if(st.getInt("lvl") < 6 && player.getActiveClassClassId().level() == 0)
					{
				...
				{
					if(st.getInt("lvl") < 7 && player.getActiveClassClassId().isMage() && classId != 49 && player.getActiveClassClassId().level() == 0)
					{
				...
				{
					if(st.getInt("lvl") < 19 && player.getRace() != Race.kamael && player.getActiveClassClassId().level() == 0)
						switch(classId)
						{
							case 0:
							case 10:
				...
				{
					if(st.getInt("lvl") < 35 && player.getRace() != Race.kamael && player.getActiveClassClassId().level() == 1)
						switch(classId)
						{
							case 1:
							case 4:
		...
		else if(event.startsWith("QM"))
		{
			...
			{
				if(player.getActiveClassClassId().isMage() && classId != 49)
