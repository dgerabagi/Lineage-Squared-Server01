// src/main/java/l2ft/gameserver/templates/item/ItemTemplate.java
...
import l2ft.gameserver.templates.item.ItemTemplate.ReuseType;
...
public abstract class ItemTemplate extends StatTemplate {
	public static enum ReuseType {
		NORMAL(SystemMsg.THERE_ARE_S2_SECONDS_REMAINING_IN_S1S_REUSE_TIME,
	...
	public static final int ITEM_DONATE_COIN = 4037;
	...
	public static final int SLOTS_ARMOR = SLOT_HEAD | SLOT_L_HAND | SLOT_GLOVES | SLOT_CHEST | SLOT_LEGS | SLOT_FEET
			| SLOT_BACK | SLOT_FULL_ARMOR;
	...
	public boolean isForPet() {
		return _type2 == TYPE2_PENDANT || _type2 == TYPE2_PET_HATCHLING || _type2 == TYPE2_PET_WOLF
				|| _type2 == TYPE2_PET_STRIDER || _type2 == TYPE2_PET_GWOLF || _type2 == TYPE2_PET_BABY;
	}
	...
	/**
	 * @return skill that player get when has equipped weapon +4 or more (for duals
	 *         SA)
	 */
	...
	public boolean isTerritoryAccessory() {
		return _itemId >= 13740 && _itemId <= 13748 || _itemId >= 14592 && _itemId <= 14600
				|| _itemId >= 14664 && _itemId <= 14672 || _itemId >= 14801 && _itemId <= 14809
	...
	public boolean isAttributeCrystal() {
		return _itemId == 9552 || _itemId == 9553 || _itemId == 9554 || _itemId == 9555 || _itemId == 9556
				|| _itemId == 9557;
	}
	...
	public boolean isTerritoryFlag() {
		return _itemId == 13560 || _itemId == 13561 || _itemId == 13562 || _itemId == 13563 || _itemId == 13564
				|| _itemId == 13565 || _itemId == 13566 || _itemId == 13567 || _itemId == 13568;
	}
	...
	public boolean isEquipable() {
		return getItemType() == EtcItemType.BAIT || getItemType() == EtcItemType.ARROW
...
// EOF Java/l2ft/gameserver/templates/item/ItemTemplate.java
