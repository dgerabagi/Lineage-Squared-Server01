...
public class ValakasManager extends Functions implements ScriptFile, OnDeathListener
{
	...
	private static final int FWV_FIXINTERVALOFVALAKAS = Config.EPIC_VALAKAS_RESPAWN_INTERVAL * 60 * 60000;
	private static final int FWV_RANDOMINTERVALOFVALAKAS = Config.EPIC_VALAKAS_RESPAWN_RANDOM * 60 * 60000;
	...
	{
		return (int) (Rnd.get((FWV_FIXINTERVALOFVALAKAS-FWV_RANDOMINTERVALOFVALAKAS) , (FWV_FIXINTERVALOFVALAKAS+FWV_RANDOMINTERVALOFVALAKAS)));
	}
