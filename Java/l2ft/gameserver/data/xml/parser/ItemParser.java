// src/main/java/l2ft/gameserver/data/xml/parser/ItemParser.java
		...
		for (Iterator<org.dom4j.Element> itemIterator = rootElement.elementIterator(); itemIterator.hasNext();) {
			...
			for (Iterator<org.dom4j.Element> subIterator = itemElement.elementIterator(); subIterator.hasNext();) {
				...
				if (subName.equalsIgnoreCase("for")) {
					 ...
					 * OptionDataHolder.getInstance().getTemplate(Integer.parseInt(optionElement.attributeValue("id")));
					 * if(optionData == null)
					 * {
...
// EOF src/main/java/l2ft/gameserver/data/xml/parser/ItemParser.java
