...
public class _410_PathToPalusKnight extends Quest implements ScriptFile
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		{
			if(st.getPlayer().getLevel() >= 18 && st.getPlayer().getActiveClassClassId().getId() == 0x1f && st.getQuestItemsCount(GAZE_OF_ABYSS_ID) == 0)
				htmltext = "master_virgil_q0410_05.htm";
			else if(st.getPlayer().getActiveClassClassId().getId() != 0x1f)
			{
				if(st.getPlayer().getActiveClassClassId().getId() == 0x20)
					htmltext = "master_virgil_q0410_02a.htm";
				else
					htmltext = "master_virgil_q0410_03.htm";
			}
			else if(st.getPlayer().getLevel() < 18 && st.getPlayer().getActiveClassClassId().getId() == 0x1f)
				htmltext = "master_virgil_q0410_02.htm";
			else if(st.getPlayer().getLevel() >= 18 && st.getPlayer().getActiveClassClassId().getId() == 0x1f && st.getQuestItemsCount(GAZE_OF_ABYSS_ID) == 1)
