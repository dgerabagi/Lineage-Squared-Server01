...
import l2ft.gameserver.model.entity.events.EventWrapper;
...
public class ClanHallAuctionEvent extends SiegeEvent<ClanHall, AuctionSiegeClanObject>
{
	...
	public void reCalcNextTime(boolean onStart)
	{
		...
		{
			long endDate = getDate().getTimeInMillis();
			...
			getResidence().getSiegeDate().setTimeInMillis(endDate);
			
			addOnTimeAction((int)((endDate-System.currentTimeMillis())/1000), new StartStopAction(EVENT, false));
			registerActions();
		}
	}
