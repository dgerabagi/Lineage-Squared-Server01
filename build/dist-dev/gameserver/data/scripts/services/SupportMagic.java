...
public class SupportMagic extends Functions {
	...
	// Updated to use new equivalents:
	// Berserker Spirit (1062) → Chant of Berserker (1562,2)
	// Improved Combat (1499) → Comb. of Pa'agrio (1536,1)
	// Improved Condition (1501) → Cond. of Pa'agrio (1538,1)
	// Improved Movement (1504) → Chant of Movement (1535,1)
	// Improved Critical Attack (1502) → Crit. of Pa'agrio (1537,1)
	// Eye of Pa'agrio (1364) added already present in arrays
	...
	private final static int[][] _mageBuff = new int[][] {
			...
			// Buffs (updated equivalents)
			{ 1, 86, 1232, 3 }, // Blazing Skin
			{ 1, 86, 1257, 3 }, // Decrease Weight
			{ 1, 86, 1392, 3 }, // Holy Resistance
			{ 1, 86, 1562, 2 }, // Chant of Berserker (replaces Berserker Spirit)
			{ 1, 86, 1536, 1 }, // Comb. of Pa'agrio (replaces Improved Combat)
			{ 1, 86, 1538, 1 }, // Cond. of Pa'agrio (replaces Improved Condition)
			{ 1, 86, 1500, 1 }, // Improved Magic (unchanged, allowed)
			{ 1, 86, 1535, 1 }, // Chant of Movement (replaces Improved Movement)
			{ 1, 86, 1503, 1 }, // Improved Shield Defense (unchanged, allowed)
			{ 1, 86, 1085, 3 }, // Acumen
	...
	private final static int[][] _warrBuff = new int[][] {
			...
			{ 1, 86, 1536, 1 }, // Comb. of Pa'agrio (replaces Improved Combat)
			{ 1, 86, 1538, 1 }, // Cond. of Pa'agrio (replaces Improved Condition)
			{ 1, 86, 1500, 1 }, // Improved Magic (unchanged)
			{ 1, 86, 1535, 1 }, // Chant of Movement (replaces Improved Movement)
			{ 1, 86, 1537, 1 }, // Crit. of Pa'agrio (replaces Improved Critical Attack)
	...
	private final static int[][] _summonBuff = new int[][] {
			...
			{ 1, 86, 4357, 4 }, // haste 2
			{ 1, 86, 4345, 6 }, // might
			{ 1, 86, 4352, 3 }, // berserker spirit (summon version)
