...
public class UserInfo extends L2GameServerPacket {
	...
	public UserInfo(Player player) {
		...
		// builder level Đ°ĐşŃ‚Đ¸Đ˛Đ¸Ń€Ń�ĐµŃ‚ Đ˛ ĐşĐ»Đ¸ĐµĐ˝Ń‚Đµ Đ°Đ´ĐĽĐ¸Đ˝Ń�ĐşĐ¸Đµ
		// ĐşĐľĐĽĐ°Đ˝Đ´Ń‹
		...
		partyRoom = player.getMatchingRoom() != null
				&& player.getMatchingRoom().getType() == MatchingRoom.PARTY_MATCHING
	...
	protected final void writeImpl() {
		...
		// 0x40 leader rights
		// siege flags: attacker - 0x180 sword over name, defender - 0x80 shield, 0xC0
		// crown (|leader), 0x1C0 flag (|leader)
		writeD(_relation);
		...
		// AttackElement (0 - Fire, 1 - Water, 2 - Wind, 3 - Earth, 4 - Holy, 5 - Dark,
		// -2 - None)
