...
public class RequestJoinPledge extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if(_pledgeType == Clan.SUBUNIT_ACADEMY && member.getLevel() >= 60)
		{
			activeChar.sendMessage("Only players below level 60 may join Academy!");
			return;
		}
		
		if(_pledgeType == Clan.SUBUNIT_ACADEMY && member.getLvlJoinedAcademy() == 100)
		{
			activeChar.sendMessage("This player have already been in Clan Academy!");
			return;
		}
