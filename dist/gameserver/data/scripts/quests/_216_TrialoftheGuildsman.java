...
/**
 * ĐšĐ˛ĐµŃ�Ń‚ Đ˝Đ° Đ˛Ń‚ĐľŃ€Ń�ŃŽ ĐżŃ€ĐľŃ„ĐµŃ�Ń�Đ¸ŃŽ Trial Of The Guildsman
 *
...
public class _216_TrialoftheGuildsman extends Quest implements ScriptFile
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		else if(event.equalsIgnoreCase("blacksmith_pinter_q0216_04.htm"))
		{
			...
			if(st.getPlayer().getActiveClassClassId().getId() == 0x38)
			{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == VALKON)
		{
			...
			{
				if(st.getPlayer().getActiveClassClassId().getId() == 0x36 || st.getPlayer().getActiveClassClassId().getId() == 0x38)
				{
	...
	public String onKill(NpcInstance npc, QuestState st)
	{
		...
		if(cond == 5 && (npcId == 20079 || npcId == 20080 || npcId == 20081))
			if(Rnd.chance(33) && st.getQuestItemsCount(ALLTRANS_INSTRUCTIONS) > 0 && st.getQuestItemsCount(PINTERS_INSTRUCTIONS) > 0)
			{
				...
				if(count < 70 && st.getPlayer().getActiveClassClassId().getId() == 0x36)
				{
				...
				if(count < 70 && st.getPlayer().getActiveClassClassId().getId() == 0x38)
				{
