...
public abstract class GameObject extends EventOwner {
	...
	public void setReflection(int reflectionId) {
		...
		if (r == null) {
			Log.debug("Trying to set unavailable reflection: " + reflectionId + " for object: " + this + "!",
	...
	public final boolean isInRealRangeZ(GameObject obj, long range) {
		if (obj == null)
			return false;
		if (obj.getReflection() != getReflection())
			return false;
		return Math.abs(obj.getZ() - getZ()) < range;
	}
