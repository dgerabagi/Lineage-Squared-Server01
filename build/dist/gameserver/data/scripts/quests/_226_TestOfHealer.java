...
public class _226_TestOfHealer extends Quest implements ScriptFile
{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == Bandellos)
		{
			if(cond == 0)
			{
				if(st.getPlayer().getActiveClassClassId() == ClassId.knight || st.getPlayer().getActiveClassClassId() == ClassId.cleric || st.getPlayer().getActiveClassClassId() == ClassId.oracle || st.getPlayer().getActiveClassClassId() == ClassId.elvenKnight)
